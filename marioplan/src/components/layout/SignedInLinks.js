...
const SignedInLinks = (props) => {
  ...
  // }
  const { profile } = props; //auth, members,
  const handleClick = () => {
  ...
  return (
    <ul>
      ...
      <li onClick={handleClick}><NavLink to='/qrcode/barcreate'><i className="small material-icons">calendar_view_day</i>Bar Code</NavLink></li>
      <li onClick={handleClick}><NavLink to='/qrcode/visitor'><i className="small material-icons">dashboard</i>Visitor Pass</NavLink></li>
